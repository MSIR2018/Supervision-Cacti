...
public class MainActivity extends AppCompatActivity
    ...
    public void onBackPressed() {
        ...
        Toast.makeText(this, "Veuillez appuyer une deuxième fois pour quitter l'application !", Toast.LENGTH_SHORT).show();
    ...
    private class MywebViewClient extends WebViewClient {
        ...
        public boolean shouldOverrideUrlLoading(WebView view, String url) {
            if (url != null && (url.startsWith(getString(R.string.menu_cacti_settings)) || url.startsWith(getString(R.string.menu_cacti_graph_view)) || url.startsWith(getString(R.string.menu_cacti_host)) || url.startsWith(getString(R.string.menu_cacti_index_old)) || url.startsWith(getString(R.string.menu_cacti_index)) )){ //ajouter les liens links
                return false;
            }
