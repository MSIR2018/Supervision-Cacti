...
public class MIBtree {
    ...
    //public static final OID SYS_UPTIME_OID = new OID(new int[] {1,3,6,1,2,1,1,3});
    public static final OID SYS_CACTI_OID = new OID(new int[] {1,3,6,1,2,1,1,1});
    public static final OID SYS_UPTIME_OID = new OID(new int[] {1,3,6,1,2,1,1,3});
    public static final OID SYS_CONTACT_OID = new OID(new int[] {1,3,6,1,2,1,1,4});
    public static final OID SYS_NAME_OID = new OID(new int[] {1,3,6,1,2,1,1,5});
    public static final OID SYS_LOCATION_OID = new OID(new int[] {1,3,6,1,2,1,1,6});
    ...
    public static final OID SYS_MEMORY_RAM_OID = new OID(new int[] {1,3,6,1,4,1,12619,9,1});
    public static final OID SYS_DISK_OID = new OID(new int[] {1,3,6,1,4,1,12619,9,2});
    public static final OID SYS_END_OID = new OID(new int[] {1,3,6,1,4,1,12619,9,3});

    //public static final OID SYS_UPTIME_OID = new OID(new int[] {1,3,6,1,2,1,1,3,0});
